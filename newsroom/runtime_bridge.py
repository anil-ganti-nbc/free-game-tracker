"""Stage 1.2 runtime bridge for Free Game Tracker (newsroom).

Identity / health / version surfaces compatible with Stage 0.5 contracts.
Does not run collectors. Does not invent historical data.
"""
